...
const CompleteTask = ({data}) => {
  return (
             <div className="h-full w-[300px] bg-green-400 rounded-xl shrink-0 py-4">
          ...
          <div className='flex justify-between mx-8 mt-4 pb-4 '>
            <button className='hover:bg-green-800 cursor-pointer transition-all ease-in-out duration-150 rounded-lg  bg-green-500 py-2 px-3 text-sm'>✅ Completed Task</button>
          </div>
     </div>
  )
}
